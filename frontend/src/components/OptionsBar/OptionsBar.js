  ...
  return (
    <div className="options-bar-div">
      <div className="options-icons">
        ...
        }}><i className="fa-solid fa-gear white-text"></i></button>
