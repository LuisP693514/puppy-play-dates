...
export default function Info({open, infoClose}) {
    ...
    return ReactDom.createPortal(
        <div className="options-modal">
            ...
            <div><span><i className="fa-regular fa-calendar orange-text"></i></span> to see/create dates.</div>
            <div><span><i className="fa-solid fa-sliders orange-text"></i></span> to filter profiles shown.</div>
            ...
            <div><span><i className="fa-solid fa-right-from-bracket orange-text"></i></span> to logout</div>
